...
function Welcome(){
    ...
    const handleScroll = () => {
        ...
        <div className='container-fluid' style={{ background: "#250000", fontFamily: 'Poppins' }}>
            ...
            class="container">
                <div class="row">
                <div class="col-12" style={{backgroundColor: 'red', height: '100px', transform: 'skewY(-45deg)'}}>
                    <div style={{backgroundColor: 'white', height: '100px', transform: 'skewX(-45deg)', fontSize: '50px', fontFamily: 'sans-serif', color: 'black'}}></div>
                </div>
                </div>
            </div> */}
        </div>
